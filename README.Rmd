...
The `DiatoViz` package provides a simple function to add silhouettes of diatoms to plots generated `ggplot2`. Currently, the package contains 87 diatom silhouettes.
